...
public class BasementServiceImp implements BasementService {
    ...
    @Override
    public BasementResponse findById(UUID id) throws BasementNotFoundException {
        return basementRepository.findById(id)
                .map(basement -> BasementResponse.builder()
                        .id(basement.getId())
    ...
    @Override
    public BasementResponse findByBasementNumber(int basementNumber) throws BasementNotFoundException {
    ...
    @Override
    public List<BasementResponse> findAll() {
        return basementRepository.findAll().stream()
                .map(basement -> BasementResponse.builder()
                        .id(basement.getId())
                        .basementNumber(basement.getBasementNumber())
                        .area(basement.getArea())
    ...
    @Override
    public BasementResponse save(Basement basement) {
