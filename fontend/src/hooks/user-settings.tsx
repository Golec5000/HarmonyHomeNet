...
export function UserSettings() {
    ...
    useEffect(() => {
        const fetchUserData = async () => {
            ...
            try {
                const response = await fetch(`http://localhost:8444/bwp/hhn/api/v1/user/get-user-by-email/${decodedToken.sub}`, {
                    headers: {
            ...
            try {
                const response = await fetch(`http://localhost:8444/bwp/hhn/api/v1/user/get-user-by-notifications?email=${decodedToken.sub}`, {
                    headers: {
                        'Authorization': `Bearer ${token}`
                    }
                })
