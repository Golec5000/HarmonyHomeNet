...
\begin{figure}[ht]
    \centering
    \includegraphics[width=.8\linewidth]{Schematy/zarys_architektury} % TO DO: coś jest nie tak na diagramie - czy będą kontenery w kontenerach? Proszę też dbać o jakość rysunków - trzeba je zacieśniać, wyrównywać, stosować ten sam styl piktogramów
