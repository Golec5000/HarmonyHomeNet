...
% TO DO: proszę dopilnować spójności i poprawności w odwoływaniach do rysunków (na rysunku ...., (rys. ....))
...
\begin{itemize}
	...
	\item \textbf{System bazodanowy} – % TO DO: powyżej zdania po myślniku odnoszą się bezpośrednio do nazwy napisanej pogrubioną czcionką. Ta zaś pozycja jest zredagowana w innym stylu. Proszę to poprawić, np. "- jest elementem odpowiadającym za przechowywanie danych przetwarzanych w systemie. " - po tym można kontynuować opis mniej wiecej tak, jak to Pan zredagował.
...
\begin{enumerate}[label=\arabic*.]
% TO DO: proszę uspójnić wyliczenia (z muślnikiem lub dwukropkiem). Jeśli jest myślnik lub dwukropek, to tekst następujący po nim powinien zaczynać się z małej litery
...
% TO DO: schemat "nie przedstawia" - bo jest nieżywotny. Pisałem o tym w szablonie pracy !!!! Chyba jednak muszę zrobić test sprawdzający, czy dyplomanci uważnie przeczytali wszystkie zalecenia.
% Proszę poprawić, np.: "przedstawiono to w lewej części schematu ... " czy też "widać to na schemacie ... po jego lewej stronie"
