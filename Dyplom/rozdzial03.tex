...
\subsection{Przyszłe usprawnienia dla zarządzania mieszkaniami}
...
\begin{figure}[ht]
    ...
    \caption{Zaimplementowany schemat dodawania dokumentów}
...
\begin{lstlisting}[language=Java, style=JavaStyle, caption=Aktualizacja zgłoszenia problemu, tabsize=2]
@Override
...
\end{itemize}
W przyszłości system forum może zostać rozszerzony o nowe funkcje, jak np.:
\begin{itemize}
...
\begin{itemize}
    ...
    \item Mechanizm \texttt{@PrePersist}, inicjalizujący datę płatności na miesiąc od chwili jej utworzenia.
\end{itemize}
