...
Mechanizm logowania w systemie „Harmony Home Net” oparto na Spring Security i tokenach JWT. Proces ten opisano w szczegółach na podstawie schematu z rysunku~\ref{fig:ebok_db_concept2}.

\begin{figure}[ht]
    \centering
    \includegraphics[scale=1.0]{rys03/proces_logowania}
    \caption{Schemat działania procesu logowania w systemie~\cite{JWToauth}}
    \label{fig:ebok_db_concept2}
\end{figure}
