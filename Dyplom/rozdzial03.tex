...
Proces implementacji polega na przełożeniu założeń architektonicznych, wymagań funkcjonalnych oraz niefunkcjonalnych na działający kod, a także integracji poszczególnych komponentów systemu w spójną, gotową do wdrożenia całość. W przypadku systemu eBOKa „Harmony Home Net” obejmie on zarówno warstwę frontendową, odpowiadającą za interakcje użytkowników, jak i backend, zajmujący się logiką biznesową i zarządzaniem danymi. Kluczowym elementem implementacji będzie integracja z bazą danych PostgreSQL uruchomioną w środowisku Docker.
...
\begin{figure}[t]
    ...
    \caption{Ogólny schemat architektury warstwowej} % TO DO: prosiłem o zacieśnianie diagramów - tutaj było za dużo białej przestrzeni
