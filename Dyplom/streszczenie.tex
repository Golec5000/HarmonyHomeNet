...
\begin{abstract}
The engineering thesis focuses on the development of an application supporting the eCSO for housing cooperatives. The aim of the project is to create a system that automates communication between the cooperative and its residents, ensuring data security and flexibility in accessing information. The designed application allows users to view contracts, invoices, reports, and announcements, as well as make online payments, all within an intuitive and user-friendly environment.
